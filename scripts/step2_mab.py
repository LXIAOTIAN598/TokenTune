...
if __name__ == "__main__":
    ...
    parser.add_argument("--centroid_file_path", type=str, required=True)
    parser.add_argument("--output_dir", type=str, required=True)
    parser.add_argument("--emb_file_paths", type=str, required=True)
    parser.add_argument("--batch_size", type=int, default=10000)
    args = parser.parse_args()

    os.makedirs(args.output_dir, exist_ok=True)
    result_line_count = semdedup_member_allocate(args.emb_file_paths, args.centroid_file_path, args.output_dir, args.batch_size)
