...
def main(
    ...
    losses_pre = torch.load(loss_path + f"token_losses_tulu3_ds2_50k_Qwen2-7B.pt")
    losses_cur = torch.load(loss_path + f"token_losses_tulu3_ds2_50k_.pt")
    ...
    final_data_path = label_path + f"token_labels_qwen_ds2_{data_type}.pt"
